...
`memory-bank/engineering/` contains the implementation rules for the modular
Bash CLI and its documentation/test workflow.

- [Engineering Architecture Patterns](architecture.md) - shell module
  boundaries, adapter boundary, config ownership, failure handling, and Bash
  boundary.
- [Frontend Engineering](frontend.md) - current CLI UI surfaces and the policy
  for any future non-CLI UI.
- [Testing Policy](testing-policy.md) - canonical local checks, Bats coverage,
...
- [Coding Style](coding-style.md) - shell/documentation style, tooling, and
  change discipline.
